...
## Context
<!-- What situation requires a decision? What's the forcing function? -->


## Decision Criteria (define BEFORE looking at options)
<!-- What makes an option good? Set these first so you can't reverse-engineer them to fit what you already want. -->
- 

## Ideal Outcome
<!-- What does a great result look like, concretely? -->
...
## Revisit Date
<!-- mirror the `review:` frontmatter date -->
