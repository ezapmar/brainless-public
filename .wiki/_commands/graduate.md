...
## Reads
- Every markdown file tagged `#status/seed` (search frontmatter `tags` and inline tags).
...
5. Never apply changes automatically. The owner must confirm one-by-one or say "apply all".
