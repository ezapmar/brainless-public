...
Bilingual policy: wiki output is Turkish-primary with an English summary block. Frontmatter must include `lang:` and `summary_en:` on every wiki file. Match source language for raw quotations.
