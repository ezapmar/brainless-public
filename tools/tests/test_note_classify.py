...
TASK = "# Sunum\n\nYarın Sinem'e dashboard örneklerini gönder.\n\n- [ ] Örnekleri gönder\n"

MEETING = """# Haftalık Review
Tarih: 2026-09-17
Katılımcılar: Murat Türker, Billur Çelik Eldeniz, Melike Ayvaz Tong
Brief Summary
...
* Melike: Anket formatını hazırlamak
* Murat: Teknik ekiple görüşmek
"""
...
class MeetingDumps(unittest.TestCase):
    ...
    def test_meeting_without_wikilinks_cannot_be_epic(self):
        people = ["Murat Türker", "Billur Çelik Eldeniz", "Melike Ayvaz Tong"]
